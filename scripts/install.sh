...
# Hive Intelligence API (Required)
...
EOL
    ...
    print_info "Please edit .env and add your Hive Intelligence API key"
}
...
show_completion() {
    ...
    echo ""
    echo "Next steps:"
    echo "1. Edit .env and add your Hive Intelligence API key"
    echo "2. Run 'npm start' to launch OnChainAgents"
    echo "3. Use '/oca:help' in Claude Code to see available commands"
    echo ""
