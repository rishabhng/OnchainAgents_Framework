...
`;
  ...
  private showError(error: Error): void {
    ...
    console.log(chalk.gray('- GitHub Issues: https://github.com/onchainagents/onchainagents.fun/issues\n'));
  }
}
